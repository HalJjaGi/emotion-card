...
- Name: emotion-card.spec.ts >> Emotion Card E2E Tests >> 1. 홈페이지 로드 확인
- Location: tests/emotion-card.spec.ts:8:7
...
Locator: locator('text=오늘의 감정을 선택하세요')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=오늘의 감정을 선택하세요')
